    ...
    Item {
        ...
        Item {
            ...
            Rectangle {
                ...
                anchors.right: parent.right
                anchors.verticalCenter: parent.verticalCenter
                width: 38 * root.s; height: 22 * root.s; radius: height / 2
                color: root.wifiOn ? Theme.verm : Theme.trackBg
                border.width: 1
                border.color: root.wifiOn ? Theme.vermLit : Theme.border
                Rectangle {
                    width: 16 * root.s; height: 16 * root.s; radius: width / 2
                    anchors.verticalCenter: parent.verticalCenter
                    x: root.wifiOn ? parent.width - width - 3 * root.s : 3 * root.s
                    color: Theme.cream
